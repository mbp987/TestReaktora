			...
			flag = false;
			{
				...
				if (flag) {
					...
					// Informacja o wyniku testu:
					{
						...
						view_result.setContentText("Udzielono łącznie " + licznik_prawidlowych + " odpowiedzi na " + liczba_pytan + " pytań łącznie" 
						+ ", czyli " + procent + "% wszystkich odpowiedzi było poprawnych");
