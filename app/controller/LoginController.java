...
public class LoginController {
	...
	void actionKeyLogin(KeyEvent event) throws SQLException {
		...
		if (rs.next()) {
			...
			a_help.setHeaderText("Błąd logowania");
			a_help.setContentText("Błędne hasło lub login");
			a_help.setTitle("Należy podać poprawne dane logowania");
			a_help.showAndWait();
		}
	}
	...
	public void initialize() {
		...
		// Nasłuchiwanie Entera w polu z hasłem aby zalogować
